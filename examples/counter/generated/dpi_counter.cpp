...
#include "counter_binding.hpp"

extern "C" void cpptb_counter_dpi_phase_dispatch(unsigned int phase);
...
struct DpiAdapter {
    ...
    static Dut bind_dut(MakeSignal make_signal) {
        return ::cpptb::generated::counter::generated::bind_dut(make_signal);
    }
    ...
    static void dispatch_phase(uint32_t phase) {
        cpptb_counter_dpi_phase_dispatch(phase);
    }
...
CPPTB_DEFINE_NAMED_DPI_RUNTIME(
    cpptb::generated::counter::generated::DpiAdapter, cpptb_counter_dpi_init, cpptb_counter_dpi_step,
    cpptb_counter_dpi_pull_outputs, cpptb_counter_dpi_next_timer_deadline, cpptb_counter_dpi_edge_interest)
