...
#include "apb_regfile_binding.hpp"

extern "C" void cpptb_apb_regfile_dpi_phase_dispatch(unsigned int phase);

namespace cpptb::generated::apb_regfile::generated {

struct DpiAdapter {
    using Dut = ::cpptb::generated::apb_regfile::Dut;
    ...
    static Dut bind_dut(MakeSignal make_signal) {
        return ::cpptb::generated::apb_regfile::generated::bind_dut(make_signal);
    }
    ...
    static void dispatch_phase(uint32_t phase) {
        cpptb_apb_regfile_dpi_phase_dispatch(phase);
    }
...
CPPTB_DEFINE_NAMED_DPI_RUNTIME(
    cpptb::generated::apb_regfile::generated::DpiAdapter, cpptb_apb_regfile_dpi_init, cpptb_apb_regfile_dpi_step,
    cpptb_apb_regfile_dpi_pull_outputs, cpptb_apb_regfile_dpi_next_timer_deadline, cpptb_apb_regfile_dpi_edge_interest)
