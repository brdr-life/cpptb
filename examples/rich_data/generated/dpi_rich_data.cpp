...
#include "rich_data_binding.hpp"

extern "C" void cpptb_rich_data_dpi_phase_dispatch(unsigned int phase);

namespace cpptb::generated::rich_data::generated {

struct DpiAdapter {
    using Dut = ::cpptb::generated::rich_data::Dut;
    ...
    static constexpr const char* result_name = "CPP_DPI_RICH_DATA_RESULT";

    template <typename MakeSignal>
    static Dut bind_dut(MakeSignal make_signal) {
        return ::cpptb::generated::rich_data::generated::bind_dut(make_signal);
    }
    ...
    static void dispatch_phase(uint32_t phase) {
        cpptb_rich_data_dpi_phase_dispatch(phase);
    }
...
CPPTB_DEFINE_NAMED_DPI_RUNTIME(
    cpptb::generated::rich_data::generated::DpiAdapter, cpptb_rich_data_dpi_init, cpptb_rich_data_dpi_step,
    cpptb_rich_data_dpi_pull_outputs, cpptb_rich_data_dpi_next_timer_deadline, cpptb_rich_data_dpi_edge_interest)
