...
#include "stalling_responder_binding.hpp"

extern "C" void cpptb_stalling_responder_dpi_phase_dispatch(unsigned int phase);

namespace cpptb::generated::stalling_responder::generated {

struct DpiAdapter {
    using Dut = ::cpptb::generated::stalling_responder::Dut;
    ...
    static constexpr const char* result_name = "CPP_DPI_STALLING_RESPONDER_RESULT";

    template <typename MakeSignal>
    static Dut bind_dut(MakeSignal make_signal) {
        return ::cpptb::generated::stalling_responder::generated::bind_dut(make_signal);
    }
    ...
    static void dispatch_phase(uint32_t phase) {
        cpptb_stalling_responder_dpi_phase_dispatch(phase);
    }
...
CPPTB_DEFINE_NAMED_DPI_RUNTIME(
    cpptb::generated::stalling_responder::generated::DpiAdapter, cpptb_stalling_responder_dpi_init, cpptb_stalling_responder_dpi_step,
    cpptb_stalling_responder_dpi_pull_outputs, cpptb_stalling_responder_dpi_next_timer_deadline, cpptb_stalling_responder_dpi_edge_interest)
