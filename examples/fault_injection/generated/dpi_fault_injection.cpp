...
#include "fault_injection_binding.hpp"

extern "C" void cpptb_fault_injection_dpi_phase_dispatch(unsigned int phase);

namespace cpptb::generated::fault_injection::generated {

struct DpiAdapter {
    using Dut = ::cpptb::generated::fault_injection::Dut;
    ...
    static constexpr const char* result_name = "CPP_DPI_FAULT_INJECTION_RESULT";

    template <typename MakeSignal>
    static Dut bind_dut(MakeSignal make_signal) {
        return ::cpptb::generated::fault_injection::generated::bind_dut(make_signal);
    }
    ...
    static void dispatch_phase(uint32_t phase) {
        cpptb_fault_injection_dpi_phase_dispatch(phase);
    }
...
CPPTB_DEFINE_NAMED_DPI_RUNTIME(
    cpptb::generated::fault_injection::generated::DpiAdapter, cpptb_fault_injection_dpi_init, cpptb_fault_injection_dpi_step,
    cpptb_fault_injection_dpi_pull_outputs, cpptb_fault_injection_dpi_next_timer_deadline, cpptb_fault_injection_dpi_edge_interest)
