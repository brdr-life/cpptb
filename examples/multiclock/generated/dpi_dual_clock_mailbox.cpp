...
struct DpiAdapter {
    ...
    static constexpr const char* result_name = "CPP_DPI_DUAL_CLOCK_MAILBOX_RESULT";

    template <typename MakeSignal>
    static Dut bind_dut(MakeSignal make_signal) {
        return ::cpptb::generated::dual_clock_mailbox::generated::bind_dut(make_signal);
    }
...
CPPTB_DEFINE_NAMED_DPI_RUNTIME(
    cpptb::generated::dual_clock_mailbox::generated::DpiAdapter, cpptb_dual_clock_mailbox_dpi_init, cpptb_dual_clock_mailbox_dpi_step,
    cpptb_dual_clock_mailbox_dpi_pull_outputs, cpptb_dual_clock_mailbox_dpi_next_timer_deadline, cpptb_dual_clock_mailbox_dpi_edge_interest)
