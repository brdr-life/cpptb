...
| I9 | `tb_cs_registers` **drives zero transactions and reports `TEST PASSED`** on Verilator 5.050 — Ibex pins v4.210 for this bench, and the observation is not reproduced there. | [`ports/ibex_cs_registers/README.md`](ports/ibex_cs_registers/README.md) | Porting it, and building a control |
